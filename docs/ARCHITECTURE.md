...
| Модуль | Файл |
|---|---|
| Category Extractor + Reality Maps | `noesis/ontology.py` |
| Synthesis Axis + Reverse Inference | `noesis/synthesis.py` |
| Engine (труба + Evidence Bundle) | `noesis/engine.py` |
| Artifact Builder / Intent Mirror | `noesis/generators.py` |
| Validator Layer | `noesis/validators.py`, `noesis/forbidden.py` |
| Method Registry | `noesis/registry.py` |
