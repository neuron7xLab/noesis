...
> `cme/theories.py`. Заборонені claims гейтуються `cme/forbidden.py`.
...
## Вихідний формат (10 секцій, `cme neuro`)
...
`cme eiic` витягає **термінальний вектор** системи: куди вона структурно прямує,
