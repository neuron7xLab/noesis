...
|---|---|---|---|
| 1 — Intentional | витягти, що користувач реально хоче | IntentMirror (9 полів + provenance) | `cme/generators.py` |
| 2 — Category/Metaphysics | які категорії керують інтерпретацією | RealityMap (домінанта/сплячі осі) | `cme/ontology.py` |
| 3 — Neurocognitive | теорії як оператори, не декор | TheoryLensReport (12 проксі) | `cme/theories.py` |
| 4 — EIIC | термінальний вектор при масштабуванні | EIICReport (provenance-теговано) | `cme/eiic.py` |
...
```
Реалізація: `cme/pipeline_v5.py:run_v5`. Кожен прогін → 10 валідаційних гейтів
