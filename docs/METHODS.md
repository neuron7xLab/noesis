...
## 1. Category Extractor — `cme/ontology.py:extract_categories`
...
## 2. Reality Map Builder — `cme/ontology.py:build_reality_maps`
...
## 3. Synthesis Axis Engine — `cme/synthesis.py:build_synthesis`
...
## 4. Reverse Inference Engine — `cme/synthesis.py:build_reverse_plan`
...
## 5. Artifact Builder — `cme/generators.py:build_artifact_deterministic`
...
## 6. Validator Layer — `cme/validators.py`
...
## 7. Pipeline + Evidence Bundle — `cme/engine.py`
Повна труба v0.3 → 8-файловий Evidence Bundle. CLI: `cme pipeline input.txt --evidence out/`.
