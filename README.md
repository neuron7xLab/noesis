...
числами: [`VERDICT.md`](VERDICT.md), [`docs/quarantine/VERDICT_V6.md`](docs/quarantine/VERDICT_V6.md).
...
## Документація
Архітектура [`docs/quarantine/NOESIS_V06_ARCHITECTURE.md`](docs/quarantine/NOESIS_V06_ARCHITECTURE.md) ·
...
цивілізаційна матриця [`docs/quarantine/CIVILIZATIONAL_METAPHYSICS.md`](docs/quarantine/CIVILIZATIONAL_METAPHYSICS.md) ·
claim governance [`docs/CLAIM_GOVERNANCE.md`](docs/CLAIM_GOVERNANCE.md) ·
валідація [`docs/quarantine/VALIDATION_V6.md`](docs/quarantine/VALIDATION_V6.md) ·
