...
from noesis.models import ActiveCategory, MirrorArtifact, RealityMaps, ReversePlan, SynthesisAxis
...
def build_reverse_plan(mirror: MirrorArtifact, maps: RealityMaps) -> ReversePlan:
    ...
    return ReversePlan(
        ...
        validation_event="Артефакт проходить `noesis validate` (0 порушень) і next_action виконано за горизонт.",
    )
